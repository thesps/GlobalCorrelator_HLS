...
open_project -reset "l1pfpuppi-ku15p-II2-JF-csim"
set_top ${l1pfTopFunc}
...
add_files -tb fullpfalgo_test_JF.cpp  -cflags "-DTESTKU15P -DHLS_pipeline_II=2 -DMP7_TOP_FUNC=${l1pfTopFunc} -DMP7_REF_FUNC=${l1pfRefFunc} -DMP7_VALIDATE=${l1pfValidate}"
...
add_files -tb data/barrel_dump.dump
