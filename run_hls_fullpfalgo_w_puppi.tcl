...
add_files puppi/firmware/simple_puppi.cpp -cflags "-DTESTMP7 -DHLS_pipeline_II=6"
add_files -tb fullpfalgo_test.cpp  -cflags "-DTESTMP7 -DHLS_pipeline_II=6 -DMP7_TOP_FUNC=${l1pfTopFunc} -DMP7_REF_FUNC=${l1pfRefFunc} -DMP7_VALIDATE=${l1pfValidate}"
