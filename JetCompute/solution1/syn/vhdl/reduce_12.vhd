...
architecture behav of reduce_12 is 
    ...
    signal grp_reduce_7_fu_140_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_7_fu_140_ap_ce : STD_LOGIC;
    ...
    signal grp_reduce_7_fu_160_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_7_fu_160_ap_ce : STD_LOGIC;
...
begin
    grp_reduce_7_fu_140 : component reduce_7
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return => grp_reduce_7_fu_140_ap_return,
        ap_ce => grp_reduce_7_fu_140_ap_ce);

    grp_reduce_7_fu_160 : component reduce_7
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return => grp_reduce_7_fu_160_ap_return,
        ap_ce => grp_reduce_7_fu_160_ap_ce);
    ...
    add_ln703_fu_180_p2 <= std_logic_vector(unsigned(grp_reduce_7_fu_160_ap_return) + unsigned(grp_reduce_7_fu_140_ap_return));
    ...
    grp_reduce_7_fu_140_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp19)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp19) and (ap_const_logic_1 = ap_const_logic_1))) then 
            grp_reduce_7_fu_140_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_7_fu_140_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_reduce_7_fu_160_ap_ce_assign_proc : process(ap_block_pp0_stage0_11001_ignoreCallOp20)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp20) and (ap_const_logic_1 = ap_const_logic_1))) then 
            grp_reduce_7_fu_160_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_7_fu_160_ap_ce <= ap_const_logic_0;
        end if; 
    end process;
