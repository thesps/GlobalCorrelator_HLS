...
architecture behav of reduce_6 is 
    ...
    signal p_s_reg_1304 : STD_LOGIC_VECTOR (4 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal p_6_reduce_1_fu_1168_ap_return : STD_LOGIC_VECTOR (4 downto 0);
    signal p_6_reg_1309 : STD_LOGIC_VECTOR (4 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_ce))) then
                p_6_reg_1309 <= p_6_reduce_1_fu_1168_ap_return;
                p_s_reg_1304 <= p_s_reduce_1_fu_1036_ap_return;
            end if;
        end if;
    end process;
    ...
    ap_return <= std_logic_vector(unsigned(p_s_reg_1304) + unsigned(p_6_reg_1309));
end behav;
