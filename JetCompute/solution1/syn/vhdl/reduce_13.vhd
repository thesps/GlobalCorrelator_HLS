...
architecture behav of reduce_13 is 
    ...
    signal p_Val2_s_reg_1304 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal grp_reduce_8_fu_1168_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_6_reg_1309 : STD_LOGIC_VECTOR (15 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_ce))) then
                p_Val2_6_reg_1309 <= grp_reduce_8_fu_1168_ap_return;
                p_Val2_s_reg_1304 <= grp_reduce_8_fu_1036_ap_return;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_return <= std_logic_vector(unsigned(p_Val2_6_reg_1309) + unsigned(p_Val2_s_reg_1304));

    grp_reduce_8_fu_1036_ap_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001_ignoreCallOp132)
    begin
    ...
    grp_reduce_8_fu_1168_ap_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001_ignoreCallOp133)
    begin
