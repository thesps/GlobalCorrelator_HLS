...
architecture behav of reduce_10 is 
    constant ap_const_logic_1 : STD_LOGIC := '1';
    constant ap_const_logic_0 : STD_LOGIC := '0';
    constant ap_const_boolean_1 : BOOLEAN := true;
    constant ap_const_boolean_0 : BOOLEAN := false;

    signal grp_reduce_12_fu_268_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_s_reg_344 : STD_LOGIC_VECTOR (15 downto 0);
    signal ap_block_state1_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state2_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state3_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal grp_reduce_12_fu_304_ap_return : STD_LOGIC_VECTOR (15 downto 0);
    signal p_Val2_4_reg_349 : STD_LOGIC_VECTOR (15 downto 0);
    signal grp_reduce_12_fu_268_ap_ce : STD_LOGIC;
    ...
    signal grp_reduce_12_fu_304_ap_ce : STD_LOGIC;
...
begin
    grp_reduce_12_fu_268 : component reduce_12
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return => grp_reduce_12_fu_268_ap_return,
        ap_ce => grp_reduce_12_fu_268_ap_ce);

    grp_reduce_12_fu_304 : component reduce_12
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        ap_return => grp_reduce_12_fu_304_ap_return,
        ap_ce => grp_reduce_12_fu_304_ap_ce);
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_ce))) then
                p_Val2_4_reg_349 <= grp_reduce_12_fu_304_ap_return;
                p_Val2_s_reg_344 <= grp_reduce_12_fu_268_ap_return;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_return <= std_logic_vector(unsigned(p_Val2_4_reg_349) + unsigned(p_Val2_s_reg_344));

    grp_reduce_12_fu_268_ap_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001_ignoreCallOp36)
    begin
        if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp36) and (ap_const_logic_1 = ap_ce))) then 
            grp_reduce_12_fu_268_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_12_fu_268_ap_ce <= ap_const_logic_0;
        end if; 
    end process;


    grp_reduce_12_fu_304_ap_ce_assign_proc : process(ap_ce, ap_block_pp0_stage0_11001_ignoreCallOp37)
    begin
        if (((ap_const_logic_1 = ap_ce) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001_ignoreCallOp37))) then 
            grp_reduce_12_fu_304_ap_ce <= ap_const_logic_1;
        else 
            grp_reduce_12_fu_304_ap_ce <= ap_const_logic_0;
        end if; 
    end process;
