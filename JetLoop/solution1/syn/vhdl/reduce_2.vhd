...
architecture behav of reduce_2 is 
    ...
    signal select_ln84_fu_166_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln84_reg_235 : STD_LOGIC_VECTOR (15 downto 0);
    ...
    signal select_ln84_5_fu_186_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal select_ln84_6_fu_193_p3 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_ce_reg)) then
                ap_return_0_int_reg <= select_ln84_reg_235;
                ap_return_1_int_reg <= select_ln84_5_fu_186_p3;
                ap_return_2_int_reg <= select_ln84_6_fu_193_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_const_logic_1))) then
                ...
                select_ln84_reg_235 <= select_ln84_fu_166_p3;
    ...
    ap_return_0_assign_proc : process(select_ln84_reg_235, ap_ce_reg, ap_return_0_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return_0 <= ap_return_0_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return_0 <= select_ln84_reg_235;
        end if; 
    end process;


    ap_return_1_assign_proc : process(select_ln84_5_fu_186_p3, ap_ce_reg, ap_return_1_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return_1 <= ap_return_1_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return_1 <= select_ln84_5_fu_186_p3;
        end if; 
    end process;


    ap_return_2_assign_proc : process(select_ln84_6_fu_193_p3, ap_ce_reg, ap_return_2_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return_2 <= ap_return_2_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return_2 <= select_ln84_6_fu_193_p3;
        end if; 
    end process;
