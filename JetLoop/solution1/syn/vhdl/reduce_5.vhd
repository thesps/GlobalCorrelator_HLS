...
architecture behav of reduce_5 is 
    ...
    signal select_ln84_fu_536_p3 : STD_LOGIC_VECTOR (15 downto 0);
    signal select_ln84_3_fu_542_p3 : STD_LOGIC_VECTOR (9 downto 0);
    signal select_ln84_4_fu_550_p3 : STD_LOGIC_VECTOR (9 downto 0);
...
begin
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_ce_reg)) then
                ap_return_0_int_reg <= select_ln84_fu_536_p3;
                ap_return_1_int_reg <= select_ln84_3_fu_542_p3;
                ap_return_2_int_reg <= select_ln84_4_fu_550_p3;
            end if;
        end if;
    end process;
    process (ap_clk)
    ...
    ap_return_0_assign_proc : process(select_ln84_fu_536_p3, ap_ce_reg, ap_return_0_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return_0 <= ap_return_0_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return_0 <= select_ln84_fu_536_p3;
        end if; 
    end process;


    ap_return_1_assign_proc : process(select_ln84_3_fu_542_p3, ap_ce_reg, ap_return_1_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return_1 <= ap_return_1_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return_1 <= select_ln84_3_fu_542_p3;
        end if; 
    end process;


    ap_return_2_assign_proc : process(select_ln84_4_fu_550_p3, ap_ce_reg, ap_return_2_int_reg)
    begin
        if ((ap_const_logic_0 = ap_ce_reg)) then 
            ap_return_2 <= ap_return_2_int_reg;
        elsif ((ap_const_logic_1 = ap_ce_reg)) then 
            ap_return_2 <= select_ln84_4_fu_550_p3;
        end if; 
    end process;
